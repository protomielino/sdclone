...
MACRO(ROBOT_DATA)
	...
	IF(HAS_SHIPSUBDIRS)
		...
		INSTALL(DIRECTORY ${REAL_SHIPSUBDIRS} DESTINATION ${TORCS_DATADIR}/drivers/${ROBOTNAME} REGEX "/CVS$" EXCLUDE REGEX "/\\.svn$" EXCLUDE REGEX "/Makefile$" EXCLUDE)
...
MACRO(ADD_TORCS_DEFINITIONS)
	...
	SET(OPTION_DEBUG false CACHE BOOL "Enable debug")
