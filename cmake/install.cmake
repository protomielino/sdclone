...
IF(IN_SOURCETREE)
  ...
  MESSAGE(STATUS "SD_DATADIR_ABS = ${SD_DATADIR_ABS}")
  MESSAGE(STATUS "SD_DATADIR = ${SD_DATADIR}")
  MESSAGE(STATUS "CMAKE_INSTALL_PREFIX = ${CMAKE_INSTALL_PREFIX}")
    ...
    INSTALL(CODE 
        "SET(CUR_DESTDIR \"\$ENV{DESTDIR}\")
         MESSAGE(STATUS \"SD_DATADIR_ABS = ${SD_DATADIR_ABS}\")
         MESSAGE(STATUS \"SD_DATADIR = ${SD_DATADIR}\")
        MESSAGE(STATUS \"CUR_DESTDIR = ${CUR_DESTDIR}\")
         IF(CUR_DESTDIR MATCHES \"[^/]\")
           STRING(REGEX REPLACE \"^(.*[^/])/*$\" \"\\\\1\" CUR_DESTDIR_CORR \"\${CUR_DESTDIR}\")
         ELSE(CUR_DESTDIR MATCHES \"[^/]\")
           SET(CUR_DESTDIR_CORR \"${CMAKE_INSTALL_PREFIX}\")
         ENDIF(CUR_DESTDIR MATCHES \"[^/]\")
         MESSAGE(STATUS \"CUR_DESTDIR_CORR = ${CUR_DESTDIR_CORR}\")
         FILE(MAKE_DIRECTORY \"\${CUR_DESTDIR_CORR}/${SD_DATADIR}/cmake\")
         FILE(WRITE \"\${CUR_DESTDIR_CORR}/${SD_DATADIR}/cmake/speed-dreams.cmake\"
         ...
         FILE(APPEND \"\${CUR_DESTDIR_CORR}/${SD_DATADIR}/cmake/speed-dreams.cmake\" \${SD_MACRO_CONTENT})")
         MESSAGE(STATUS "CUR_DESTDIR = ${CUR_DESTDIR}")
         MESSAGE(STATUS "CUR_DESTDIR_CORR = ${CUR_DESTDIR_CORR}")
         MESSAGE(STATUS "INSTALL_SD_CMAKE called")
