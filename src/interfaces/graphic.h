...
#define GR_ATT_SKYDOME		"Sky Dome Value"
#define GR_ATT_RAINDENSITY	"Rain Density"
#define GR_ATT_RAINBOOL		"Rain Bool"
#define GR_ATT_QUICKRACE	"Quickrace"
#define GR_ATT_TIMEDAY		"Timeday"
#define GR_ATT_WEATHER		"Weather"
