...
public class PitProperties extends PropertyPanel
{
	...
	private void initialize()
	{
		...
		addTextField(this, 2, entryTextField, getEditorFrame().getTrackData().getMainTrack().getPits().getEntry(), 120, 100);
		addTextField(this, 3, startTextField, getEditorFrame().getTrackData().getMainTrack().getPits().getStart(), 120, 100);
		addTextField(this, 4, startBuildingsTextField, getEditorFrame().getTrackData().getMainTrack().getPits().getStartBuildings(), 120, 100);
		addTextField(this, 5, stopBuildingsTextField, getEditorFrame().getTrackData().getMainTrack().getPits().getStopBuildings(), 120, 100);
		addTextField(this, 6, maxPitsTextField, getEditorFrame().getTrackData().getMainTrack().getPits().getMaxPits(), 120, 100);
		addTextField(this, 7, endTextField, getEditorFrame().getTrackData().getMainTrack().getPits().getEnd(), 120, 100);
		addTextField(this, 8, exitTextField, getEditorFrame().getTrackData().getMainTrack().getPits().getExit(), 120, 100);
		addTextField(this, 9, widthTextField, getEditorFrame().getTrackData().getMainTrack().getPits().getWidth(), 120, 40);
		addTextField(this, 10, lengthTextField, getEditorFrame().getTrackData().getMainTrack().getPits().getLength(), 120, 40);

		add(getIndicatorComboBox(), null);

		addTextField(this, 12, speedLimitTextField, getEditorFrame().getTrackData().getMainTrack().getPits().getSpeedLimit(), 120, 40);
	...
	private void createPits()
	{
		...
		while (it.hasNext())
		{
			...
			if (name.equals(getEditorFrame().getTrackData().getMainTrack().getPits().getEntry()))
			{
				pitEntry = obj;
			}else if (name.equals(getEditorFrame().getTrackData().getMainTrack().getPits().getStart()))
			{
				pitStart = obj;
			}else if (name.equals(getEditorFrame().getTrackData().getMainTrack().getPits().getStartBuildings()))
			{
				pitStartBuildings = obj;
			}else if (name.equals(getEditorFrame().getTrackData().getMainTrack().getPits().getStopBuildings()))
			{
				pitStopBuildings = obj;
			}else if (name.equals(getEditorFrame().getTrackData().getMainTrack().getPits().getEnd()))
			{
				pitEnd = obj;
			}else if (name.equals(getEditorFrame().getTrackData().getMainTrack().getPits().getExit()))
			{
				pitExit = obj;
			}
		}
		...
		if(getEditorFrame().getTrackData().getMainTrack().getPits().getSide().equals("left"))
		{
		...
		side.setSideEndWidth(getEditorFrame().getTrackData().getMainTrack().getPits().getWidth()*3);
		...
		side.setBorderHeight(0);
		side.setBorderWidth(0);
		side.setSideStartWidth(getEditorFrame().getTrackData().getMainTrack().getPits().getWidth()*3);
		side.setSideSurface("road1");
		side.setBarrierHeight(1);
		side.setBarrierWidth(0.1);
