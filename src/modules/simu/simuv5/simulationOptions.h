...
public:
    ...
    bool  tyre_damage; 	      ///< Tyre damage effects.
    bool  tyre_temperature;   ///< Tyre temperature effects.
    bool  compounds;          ///< Compounds choice
    bool  engine_temperature; /// < Engine temperature effects
    ...
    bool  engine_damage;      ///< If true, damage can cause lower engine response.
