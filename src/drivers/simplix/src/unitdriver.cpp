 ...
 PCarSettings *CarSettings,	PSituation Situation)
{
    ...
    *strrchr(TrackNameBuffer, '.')	= '\0';			// Truncate at point
    ...
    for (int I	= 0; I < 2;	I++)
    {
        TireLimitFront = MAX(TireLimitFront, (tdble) 0.10f);
        LogSimplix.debug("#oTireLimitFront	  = %.3f\n",TireLimitFront);
    }
    tdble TireLimitRear = 0.0;
    for (int I	= 2; I < 4;	I++)
    {
        TireLimitRear	= MAX(TireLimitRear, (tdble) 0.10f);
...
{
    double	Right =	(oCar->_tyreTreadDepth(0));
    double	Left = (oCar->_tyreTreadDepth(1));
...
{
    double	Right =	(oCar->_tyreTreadDepth(2));
    double	Left = (oCar->_tyreTreadDepth(3));
    return	100	* MIN(Right,Left);
}
//==========================================================================*
