...
public:
    Pit();
    void   init(const tTrack* track, const tSituation* situation, MyCar* car, int pitdamage, double pitgripfactor, double pitentrymargin, int rain, double tireweardanger);
    void   update();
    double dist();
    void   pitCommand();
