...
extern "C" int moduleWelcome(const tModWelcomeIn* welcomeIn, tModWelcomeOut* welcomeOut)
{
    ...
    if (strncmp(robotName,"usr_trb1",strlen("usr_trb1")) == 0)
		SetUpUSR_trb1();
	else 
		SetUpUSR();
...
extern "C" int usr_trb1(tModInfo *modInfo)
{
  ...
  snprintf(pathBuffer, BUFSIZE, "drivers/usr_trb1/usr_trb1.xml");
  snprintf(nameBuffer, BUFSIZE, "usr_trb1");
