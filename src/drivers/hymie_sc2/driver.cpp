/***************************************************************************
    ...
    version              : $Id: driver.cpp,v 1.14 2005/02/01 18:33:34 berniw Exp $
...
void Driver::saveLearning()
{
 ...
 {
  case RM_TYPE_QUALIF:
   snprintf(buffer, BUFSIZE, "drivers/%s/%d/qualifying/%s.learn", DRIVERNAME, INDEX, trackname);
   break;
  case RM_TYPE_PRACTICE:
   snprintf(buffer, BUFSIZE, "drivers/%s/%d/practice/%s.learn", DRIVERNAME, INDEX, trackname);
   break;
  case RM_TYPE_RACE:
   sprintf(buffer, "drivers/%s/%d/%s.learn", DRIVERNAME, INDEX, trackname);
   break;
 }
...
void Driver::initTrack(tTrack* t, void *carHandle, void **carParmHandle, tSituation *s)
{
 ...
 snprintf(buffer, BUFSIZE, "drivers/%s/%d/default.xml", DRIVERNAME, INDEX);
 *carParmHandle = GfParmReadFile(buffer, GFPARM_RMODE_STD);
 ...
 snprintf(buffer, BUFSIZE, "drivers/%s/%d/%s", DRIVERNAME, INDEX,trackname);
 ...
 switch (s->_raceType) {
  case RM_TYPE_QUALIF:
   snprintf(buffer, BUFSIZE, "drivers/%s/%d/qualifying/%s", DRIVERNAME, INDEX, trackname);
   break;
  case RM_TYPE_PRACTICE:
   snprintf(buffer, BUFSIZE, "drivers/%s/%d/practice/%s", DRIVERNAME, INDEX, trackname);
   break;
  case RM_TYPE_RACE:
   snprintf(buffer, BUFSIZE, "drivers/%s/%d/race/%s", DRIVERNAME, INDEX, trackname);
   break;
  default:
   break;
 }
