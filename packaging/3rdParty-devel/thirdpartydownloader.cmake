...
if(NOT CACHED_URL STREQUAL "")
   ...
   if(IS_FILE_URL)
      set(SDL_1_URL "${CACHED_URL}/${SDL1_FILE}")
      set(SDL_2_URL "${CACHED_URL}/${SDL2_FILE}")
      ...
      set(SDL_1_URL "${CACHED_URL}/${SDL1_FILE} ${SDL_1_URL}")
      set(SDL_2_URL "${CACHED_URL}/${SDL2_FILE} ${SDL_2_URL}")
...
SD_DownloadIfNeeded(${DOWNLOAD_DIRECTORY}/${SDL1_FILE} ${SDL_1_URL})
SD_DownloadIfNeeded(${DOWNLOAD_DIRECTORY}/${SDL2_FILE} ${SDL_2_URL})
